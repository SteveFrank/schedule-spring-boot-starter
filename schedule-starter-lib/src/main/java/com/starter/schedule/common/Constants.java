package com.starter.schedule.common;

import com.starter.schedule.domain.ExecOrder;
import com.starter.schedule.task.ScheduledTask;
...
public class Constants {
    ...
    public static final Map<String, ScheduledTask> scheduledTasks = new ConcurrentHashMap<>();
